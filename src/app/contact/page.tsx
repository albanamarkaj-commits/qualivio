...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Contact Qualivio for pharmacovigilance consulting, life sciences education, and drug safety support.",
};
    ...
    <>
      ...
      <Section>
        <div className="grid gap-10 md:grid-cols-[0.8fr_1.2fr]">
          {/* Contact details */}
          <div className="rounded-2xl border border-[#2E2E36] bg-[#1A1A1E] p-8">
            ...
            <div className="mt-6 flex flex-col gap-4">
              <div>
                ...
                <a
                  ...
                  className="mt-1 block text-sm text-[#4ECDC4] hover:text-[#7C6AF7] transition-colors"
                >
                  {site.email}
                </a>
              </div>
            ...
            <div className="mt-8 rounded-xl border border-[#2E2E36] bg-[#0D0D0F] p-4">
              <p className="text-xs leading-6 text-[#9896B6]">
                For consulting, training, content partnerships, or life sciences
                education enquiries — we respond within 1–2 business days.
              </p>
            </div>
          </div>
