...
export const metadata: Metadata = {
  title: "About",
  description: "Learn about Qualivio's mission, vision, values, and pharmacovigilance expertise.",
};
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-white px-6 pb-20 pt-24">
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-[#6B6A8F]">
            Qualivio exists to make drug safety knowledge clearer, more practical, and more accessible for professionals working in regulated life sciences environments.
          </p>
        </div>
      </section>
      ...
      <Section eyebrow="Foundation" title="Why Qualivio exists.">
        <div className="grid gap-6 md:grid-cols-2">
          <Card accent="primary">
            ...
            <h3 className="text-2xl font-bold text-[#0D0D0F]" style={{ fontFamily: "var(--font-space-grotesk)" }}>Mission</h3>
            <p className="mt-4 leading-8 text-[#6B6A8F]">
              To advance excellence in pharmacovigilance through trusted education, consulting, and practical resources — making complex science accessible to every professional who needs it.
            </p>
          </Card>
          <Card accent="teal">
            <div className="mb-4 h-0.5 w-8 bg-[#4ECDC4]" />
            <h3 className="text-2xl font-bold text-[#0D0D0F]" style={{ fontFamily: "var(--font-space-grotesk)" }}>Vision</h3>
            <p className="mt-4 leading-8 text-[#6B6A8F]">
              A life sciences ecosystem where safety systems are clear, compliant, human-centred, and continuously improving — powered by professionals who are confident in their knowledge.
            </p>
          </Card>
        </div>
      </Section>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {values.map((value) => (
            <div key={value.label} className="rounded-2xl border border-[#2E2E36] bg-[#1A1A1E] p-6">
              ...
              <h3 className="font-bold text-[#E8E6FF]" style={{ fontFamily: "var(--font-space-grotesk)" }}>{value.label}</h3>
      ...
      <section className="border-t border-[#2E2E36] bg-[#0D0D0F] px-6 py-20 text-center">
        <h2 className="text-3xl font-bold text-[#E8E6FF]" style={{ fontFamily: "var(--font-space-grotesk)" }}>Work with Qualivio.</h2>
        <p className="mx-auto mt-4 max-w-xl text-base text-[#9896B6]">
          Whether you need consulting support, educational resources, or a focused conversation — we are here.
        </p>
