...
export default function Home() {
  return (
    <>
      {/* Hero */}
      <section className="relative overflow-hidden bg-[#0D0D0F] px-6 pb-24 pt-24 sm:pb-32 sm:pt-32">
        {/* Background glow */}
        ...
        <div className="relative mx-auto max-w-5xl text-center">
          ...
          <div className="mb-8 flex justify-center">
            <div className="relative flex h-16 w-16 items-center justify-center rounded-2xl border border-[#2E2E36] bg-[#1A1A1E] text-white shadow-[0_0_40px_rgba(124,106,247,0.2)]">
              <QMark size={36} />
            </div>
          </div>
          ...
          {/* Headline */}
          <h1
            className="mx-auto max-w-4xl text-5xl font-bold leading-tight tracking-tight text-[#E8E6FF] sm:text-6xl md:text-7xl"
          ...
          {/* Tagline */}
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-[#9896B6]">
          ...
          {/* Divider line (teal — brand rule) */}
          <div className="mx-auto mt-16 h-px w-24 bg-[#4ECDC4]" />
        </div>
      </section>

      {/* Brand statement bar */}
      <div className="border-y border-[#2E2E36] bg-[#1A1A1E] px-6 py-6">
      ...
      <Section
        eyebrow="Services"
        title="Specialized support for regulated life sciences teams."
      ...
      >
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[
            {
              label: "Trustworthy",
              body: "We earn confidence through accuracy and transparency — every insight is grounded in evidence.",
            },
            {
              label: "Clear",
              body: "Complex science, explained without jargon. We make pharmacovigilance accessible and actionable.",
            },
            {
              label: "Expert",
              body: "Deep domain knowledge from professionals who speak the language of regulators and safety teams.",
            },
            {
              label: "Modern",
              body: "A fresh perspective on an established discipline — digital-first, globally relevant.",
            },
            {
              label: "Approachable",
              body: "Rigour without intimidation. We educate without condescending to our audience.",
            },
            {
              label: "Precise",
              body: "Every word and design choice earns its place. No filler, no buzzwords, no vague claims.",
            },
          ].map((item) => (
            <div
              key={item.label}
      ...
      {/* CTA banner */}
      <section className="relative overflow-hidden bg-[#1A1A1E] px-6 py-20">
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-base leading-8 text-[#9896B6]">
            Tell us what you are building, improving, or preparing for. Qualivio
            will respond with clarity and care.
          </p>
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Button href="/contact">Book a Consultation →</Button>
            <Link
              href={`mailto:hello@qualivio.com`}
